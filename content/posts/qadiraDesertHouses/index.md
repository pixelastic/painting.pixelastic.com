...
description: "Built modular desert houses for Pathfinder encounters in Qadira. Used sandpaper for wall texture, foam carving for details, and Jenga blocks for walls. Stackable and easy to store."
---

<!-- Image 1 -->
![Completed modular desert houses showing both pink and tan color schemes](image-20260420173256276.png)
...
<!-- Image 2 -->
![Cardboard boxes used as base material for cubic house shapes](image-20260420173302634.png)

Since the houses have very cubic shapes, I used boxes as the starting material.

<!-- Image 3 -->
![Boxes with foam glued to bottom for added base surface area](image-20260420173308545.png)

I glued foam at the bottom of the boxes to create more surface area for attaching them to a base.

<!-- Image 4 -->
![Box mounted on cardboard base with foam slices around perimeter](image-20260420173315051.png)
...
<!-- Image 5 -->
![Cut sandpaper with holes for windows and doors](image-20260420173321010.png)
...
<!-- Image 6 -->
![Wall with marked holes showing where to carve foam and draw bricks](image-20260420173326792.png)

I transferred the holes from my template to the walls so I'd know where to carve the foam and where to draw bricks.

<!-- Image 7 -->
![Carved foam with doors, windows, and brick texture visible through holes](image-20260420173332458.png)
...
<!-- Image 8 -->
![Back view of house showing windows on multiple sides](image-20260420173338329.png)

The back view shows windows on multiple sides, not just one.

<!-- Image 9 -->
![House with sandpaper texture layer glued back over walls](image-20260420173343804.png)

After gluing the sandpaper back over the walls, the structure starts taking shape.

<!-- Image 10 -->
![Back view showing edge where sandpaper doesn't meet perfectly](image-20260420173349737.png)

There's an edge on the back where the sandpaper doesn't meet properly, but I'll hide that flaw later with texture.

<!-- Image 11 -->
![Roof with chunky parapet made from medicine tubes and domes](image-20260420173356826.png)
...
<!-- Image 12 -->
![House covered in sand and glue texture with raised trapdoor on roof](image-20260420173403722.png)
...
<!-- Image 13 -->
![Close-up showing thick texture layers smoothing material transitions](image-20260420173410894.png)

You can see the areas where I layered lots of texture to smooth the transition between different materials.

<!-- Image 14 -->
![First house painted in orange-pink colors that didn't work well](image-20260420173417144.png)
...
<!-- Image 15 -->
![Large cardboard box used as base for longer building structure](image-20260420173425725.png)

For another building, I wanted to make a longer structure, so I used a large cardboard box as the base.

<!-- Image 16 -->
![Several handmade doors to supplement pre-printed collection](image-20260420173434458.png)
...
<!-- Image 19 -->
![Roof with integrated parapet and woven mat surface](image-20260420173455944.png)
...
<!-- Image 20 -->
![Basic house structure built around cardboard box](image-20260420173505093.png)
...
<!-- Image 21 -->
![Stacked Jenga blocks with foam and sandpaper for alleyway walls](image-20260420173519313.png)
...
<!-- Image 22 -->
![Wall section showing holes revealing brick texture underneath](image-20260420173526880.png)

The wall holes I make to show the bricks visible through the gaps.

<!-- Image 23 -->
![Wall with various torn holes creating broken appearance](image-20260420173532709.png)

Sometimes I just make holes in the center, or I tear pieces as if it's a bit broken away at the top or bottom.

<!-- Image 24 -->
![Multiple wall pieces with Jenga blocks, foam and sandpaper layers](image-20260420173538987.png)
...
<!-- Image 25 -->
![Wall with blue pen bleed showing through brick texture](image-20260420173551444.png)
...
<!-- Image 26 -->
![First buildings painted in pinkish colors with drybrushing](image-20260420173559444.png)
...
<!-- Image 27 -->
![Buildings painted with improved tan and white color scheme](image-20260420173615848.png)
...
<!-- Image 28 -->
![Building details painted in yellow ochre highlighting stone features](image-20260420173621997.png)

You can see where I painted all the small details in yellow.

<!-- Image 29 -->
![Wall and foam staircase with nails for weight](image-20260420173629258.png)
...
<!-- Image 30 -->
![Finished painting with varied brick colors, washes and drybrushing](image-20260420173635739.png)
...
<!-- Image 31 -->
![Terrain pieces with bottoms painted black marking completion](image-20260420173641802.png)
...
<!-- Image 32 -->
![Scene with Qadira soldier showing modular stacking capability](image-20260420173649387.png)
...
<!-- Image 33 -->
![Desert city layout with walls separating different areas](image-20260420173656155.png)

Another view with the walls separating different areas.

<!-- Image 34 -->
![Overview showing bright blue windows reflecting sky](image-20260420173703737.png)

Another overview. I painted the windows in a very bright blue to simulate the sky reflecting on the glass.

<!-- Image 35 -->
![Stacked house showing modular construction](image-20260420173711394.png)

This house stacked. Don't look too closely. If you look too closely, you can see the craft isn't great, but it does the job.

<!-- Image 36 -->
![Close-up of resin-cast Zombicide door from silicone mold](image-20260420173718336.png)
...
<!-- Image 37 -->
![Detail shot of desert houses with tan color scheme](image-20260420173724893.png)

Another nice shot.

<!-- Image 38 -->
![All desert terrain stored efficiently in single biome drawer](image-20260420173734102.png)
