...
<!-- 1 -->
![Orange painted tiles looking like cake just pulled from oven](image-20260407174457570.png)

I love this intro shot: looks like I just pulled a cake out of the oven!

<!-- 2 -->
![Room dimensions cut from cardboard templates](image-20260407174533656.png)

Here I cut the room dimensions out of cardboard first.

<!-- 3 -->
![Cardboard templates glued onto foam boards for precise cutting](image-20260407174521939.png)
...
<!-- 4 -->
![Cut foam tiles test fitted together to verify dimensions](image-20260407174547856.png)

Test fitting everything together to see what I get.

<!-- 5 -->
![Lines traced for individual tiles and embossed with tilted cutter](image-20260407174556750.png)

I started tracing lines for the individual tiles, then tilted my cutter slightly to emboss between each tile.

<!-- 6 -->
![Aluminum foil ball rolled over surface creating stone texture](image-20260407174603895.png)

Rolling an aluminum foil ball over the surface to create a stone texture.

<!-- 7 -->
![Complicated tile patterns that took long but don't show well](image-20260407174612106.png)
...
<!-- 8 -->
![Interlocking brick pattern with offset and complex crossing lines](image-20260407174619847.png)
...
<!-- 9 -->
![Chapel tiles test fitted to ensure proper dimensions for safe zone](image-20260407174634228.png)

The chapel is their safe zone where they can sleep properly and meet all the NPCs. Making sure everything fits correctly.

<!-- 10 -->
![Floor tiles carved with not perfectly straight lines to be corrected](image-20260407174641142.png)

Started making the floor tiles. My lines weren't always straight but I tried to correct that later.

<!-- 11 -->
![Two small side sections kept separate for modular 6x6 center tile reuse](image-20260407174649034.png)
...
<!-- 12 -->
![Aluminum foil ball texture rolled across all tiles](image-20260407174656455.png)

Rolled the aluminum foil ball all over.

<!-- 13 -->
![Tiles painted black with reference photo of paint tubes for color plan](image-20260407174706053.png)
...
<!-- 14 -->
![Paint tubes selected for blue tones in second room](image-20260407174713559.png)

For the other room I wanted to go with blue tones.

<!-- 16 -->
![Bright orange overbrush looking weird but trusting the painting process](image-20260407174728508.png)

First overbrush layer with bright orange. This is where you really need to trust the process because it looks too weird.

<!-- 17 -->
![Additional drybrush layer making tiles look much better](image-20260407174735673.png)

After an additional drybrush on top, it's starting to look like something. I'm happy with this.

<!-- 19 -->
![Blue room started with very bright turquoise base coat](image-20260407174748960.png)

Same principle but on the blue room. Started with very bright turquoise.

<!-- 21 -->
![Yellow drybrush creating multiple relief levels on blue tiles](image-20260407174803268.png)

Another lighter drybrush to create multiple levels of relief, this time with yellow directly.

<!-- 22 -->
![Each room with distinct color scheme looking good at this stage](image-20260407174810765.png)

Where I'm at now. Each room really has its own color and I'm quite happy with the result at this stage.

<!-- 23 -->
![Tiles with slightly different tints using cream drybrush and diluted oils](image-20260407174819153.png)
...
<!-- 24 -->
![Final drybrush layer reunifying all tiles with consistent tone](image-20260407174832708.png)

I think I did another drybrush on top to reunify everything.

<!-- 25 -->
![Overly busy room with complicated pattern and ugly damage that failed](image-20260407174846244.png)
...
<!-- 26 -->
![Orange cake-like tiles perfect for pharaoh or tomb themes](image-20260407174856860.png)
...
<!-- 27 -->
![Miniature on tile showing scale and proper fit](image-20260407174907226.png)

Giving an idea of scale. Checking that the miniature fits properly.

<!-- 28 -->
![Finished orange tiles with better lighting showing great result](image-20260407174914492.png)

Another angle with better lighting. Yes, I'm happy with how this turned out. Looks really good.

<!-- 29 -->
![Large floorboard-style tiles being started](image-20260407174923111.png)

Starting on the large tiles that are more like floorboards.

<!-- 30 -->
![Three versions showing dark brown overbrush and progressive light brown drybrushing](image-20260407175030308.png)
...
<!-- 31 -->
![Acrylic inks added to select boards for varied tints without uniformity](image-20260407175102419.png)
...
<!-- 32 -->
![Oil wash applied unifying floorboards with weathered look](image-20260407175205565.png)

After applying an oil wash on top to unify everything and give a slightly weathered look.

<!-- 33 -->
![Red room tiles with strong red base coat](image-20260407174947969.png)

Moving to another room, the red side with quite strong red.

<!-- 34 -->
![Tiles painted with purple tones for variation](image-20260407175008577.png)

For these pieces I wanted to go a bit purple.

<!-- 35 -->
![Pink drybrush added using vivid colors to be toned by wash](image-20260407175040699.png)
...
<!-- 36 -->
![Purple and blue inks used to vary tile colors slightly](image-20260407175113145.png)

Same thing - I reused different inks, purple and blue, to slightly change the color of some tiles compared to others.

<!-- 37 -->
![Brown wash applied to darken tiles slightly](image-20260407175139006.png)

Applying a wash on top, a bit brown to darken it slightly.

<!-- 38 -->
![Orange drybrush over initially very red tiles](image-20260407175017486.png)

Orange drybrush on my tile that was initially very red.

<!-- 39 -->
![Acrylic inks modifying stone tints to reduce uniformity](image-20260407175051057.png)

Again using acrylic inks to slightly modify the tint of some stones on the tiles to make it less uniform.

<!-- 40 -->
![Finished red tiles after oil wash application](image-20260407175151005.png)

After the oil wash has been applied on top.

<!-- 41 -->
![Failed tile with overly complicated pattern still disliked](image-20260407175126617.png)

Still the one I like least.

<!-- 42 -->
![Failed salvage attempt with drybrush masking everything like swimming pool bottom](image-20260407175223222.png)
