...
date: 2026-04-07
layout: post
description: "Batch painted diverse miniature in evening to test speedpaint colors. Mix from Dungeons & Lasers, Heroclix, HeroQuest, Zombicide, and Reaper."
---

Here's an overview of miniature I batch painted in an evening or two thanks to speedpaints. I had just received my speedpaint pack and wanted to try out all the colors to see what they looked like, which ones I liked, and which ones I didn't. [Similar to my creature batch](../creatureBatch/), I gathered a bunch of miniature from various sources to test them out.

<!-- 1 -->
![Mix of painted miniature from various game systems testing speedpaints](image-20260407121055784.png)

<!-- 2 -->
![Diverse collection including civilians, heroes, and creatures from multiple sources](image-20260407121108723.png)
...
<!-- 3 -->
![Dead Halfling tokens used as battlefield corpse markers](image-20260407121120087.png)
...
<!-- 4 -->
![Batch nearly finished before varnishing showing uniform color scheme](image-20260407121128865.png)
...
<!-- 5 -->
![Finished tabletop-ready miniature with cohesive look despite diverse sources](image-20260407121136781.png)
