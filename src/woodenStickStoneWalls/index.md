...
<!-- Image 1 -->
![Finished modular stone walls made from wooden sticks with miniature for scale](image-20260408112837352.png)
...
<!-- Image 2 -->
![Wooden construction set with interlocking sticks](image-20260408112848669.png)
...
<!-- Image 3 -->
![Different sizes of wooden sticks arranged showing their lengths](image-20260408112855507.png)
...
<!-- Image 4 -->
![Wooden walls placed on game tiles showing door placement in corridor](image-20260408112903217.png)
...
<!-- Image 5 -->
![Testing different texturing methods including foam and tiles](image-20260408112910831.png)
...
<!-- Image 6 -->
![Wooden stick wrapped in textured wallpaper showing final approach](image-20260408112918051.png)
...
<!-- Image 7 -->
![Multiple wooden sticks sorted by size ready for wrapping](image-20260408112931521.png)
...
<!-- Image 8 -->
![Process of wrapping wooden stick with wallpaper using wood glue](image-20260408112937581.png)
...
<!-- Image 9 -->
![Wrapped sticks with excess wallpaper at the ends](image-20260408112945435.png)

Once I've wrapped them all. All I need to do after is cut the ends that stick out a bit.

<!-- Image 10 -->
![Adding wallpaper texture to stick ends with glue gun](image-20260408112953079.png)
...
<!-- Image 11 -->
![Completed unpainted walls with miniature for scale](image-20260408113516512.png)

Once finished, with the miniature again for scale to see what it looks like.

<!-- Image 12 -->
![Walls painted with black modpodge texture base coat](image-20260408113523255.png)
...
<!-- Image 13 -->
![Walls after first grey drybrushing showing stone texture](image-20260408113534089.png)

Once it's well dried, I do the first drybrushing in grey. It's already starting to look interesting.

<!-- Image 14 -->
![Finished walls with washes in black, blue, green and brown](image-20260408113544520.png)
