...
<!-- Image 1 -->
![Drawer shelves storing organized Zombicide 3D terrain pieces](image-20260409171808711.png)
...
<!-- Image 2 -->
![Three drawers containing game components, zombies, and barricades for Zombicide](image-20260409171815558.png)
...
<!-- Image 3 -->
![Drawer filled with stone floor tiles and water tiles for Zombicide scenarios](image-20260409171829820.png)
...
<!-- Image 4 -->
![Wood floor tiles in various sizes for Zombicide house interiors](image-20260409171836518.png)
...
<!-- Image 5 -->
![Stone tiles in 1x1 and 2x1 sizes for outdoor Zombicide streets](image-20260409171842583.png)

Same thing for stone tiles, all the outdoor squares that aren't on main streets. Again, some are 2 long, sometimes just 1x1.

<!-- Image 6 -->
![Drawer full of custom-made hedges for line of sight blocking](image-20260409171849420.png)

All the [hedges](../zombicideHedges/) that block line of sight. Not nearly enough are provided in the base game, so I made my own.

<!-- Image 7 -->
![Various wall types including stone and wood walls in different styles](image-20260409171855659.png)
...
<!-- Image 8 -->
![Drawer with barricades, hedges, and doors counted for maximum scenario needs](image-20260409171902424.png)
